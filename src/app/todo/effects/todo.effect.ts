...
export class TodoEffects {
  ...
  create$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(({ userId, todo }) =>
        this.todoService.create(userId, todo).pipe(
          map((result) =>
            TodoActions.createSuccess({ userId: result.userId, todo: result })
          ),
  ...
  update$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(({ userId, todo }) =>
        this.todoService.update(userId, todo).pipe(
          map((result) =>
            TodoActions.updateSuccess({ userId: result.userId, todo: result })
          ),
